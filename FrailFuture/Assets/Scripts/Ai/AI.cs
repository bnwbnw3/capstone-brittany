...
public class AI
{
    ...
    private void ConstructorHelper(MazeGroup mazeInfo, Neutrality starting, Brain brain, AIEndingsScore score, int currentGraphIndex = 0)
    {
        ...
        else
        {
            ...
            AiCurrentDesire = pf.findNextDesiredInput(0, AiDesiredEndIndex, currentGraphIndex).input;
    ...
    public void informOfPick(int userChoice)
       {
           ...
           AiCurrentDesire = pf.findNextDesiredInput(userChoice, AiDesiredEndIndex).input;
